...
import bawang from "../../../../public/bawang.jpeg";
        ...
        <div className="flex flex-col lg:flex-row lg:space-x-10 bg-white rounded-lg shadow-lg overflow-hidden">
          ...
          <div className="flex-1 flex flex-col items-center lg:items-start justify-center p-6 lg:px-10">
            <p className="text-lg font-medium mb-6 text-center lg:text-left text-gray-700 leading-relaxed">
              Tambahkan sentuhan kelezatan pada setiap hidangan Anda dengan
              Bawang Goreng kami—bawang merah iris yang digoreng hingga keemasan
              dan renyah. Ideal sebagai taburan atau penyedap, bawang goreng ini
              memberikan cita rasa gurih dan aroma yang menggugah selera pada
              aneka masakan Indonesia. Ciptakan pengalaman makan yang istimewa
              dengan bumbu tabur kami!
            </p>
            <Link
              href={`https://wa.me/6289508926250?text=${encodeURIComponent(
                "Halo! Saya tertarik untuk memesan Bawang Goreng. Bisa dibantu untuk pemesanan saya? Terima kasih!"
              )}`}
            >
